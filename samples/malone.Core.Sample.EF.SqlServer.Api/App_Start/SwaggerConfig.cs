using malone.Core.Sample.EF.SqlServer.Api.App_Start;
            ...
            config.EnableSwagger(swagger =>
                    {
                        ...
                        //
                        //swagger.SingleApiVersion("v1", "malone.Core.Sample.EF.SqlServer.Api");
                        ...
                        //
                        swagger.IncludeXmlComments(System.IO.Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory, "bin", "malone.Core.Sample.EF.SqlServer.Api.xml"));
