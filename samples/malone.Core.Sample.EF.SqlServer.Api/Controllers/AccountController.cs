...
using malone.Core.Sample.EF.SqlServer.Api.Models;
...
namespace malone.Core.Sample.EF.SqlServer.Api.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        private SignInBusinessComponent _signInManager;
