...
using malone.Core.Identity.AdoNet.Firebird.Entities;
using malone.Core.Sample.AdoNet.Firebird.Api.Models.v2;
using malone.Core.Sample.AdoNet.Firebird.Api.Providers;
using malone.Core.Sample.AdoNet.Firebird.Api.Results;
...
namespace malone.Core.Sample.AdoNet.Firebird.Api.Controllers.v2
{
    [Authorize]
    [ApiVersion("2.0")]
