...
using malone.Core.Sample.AdoNet.Firebird.Api.App_Start;
            ...
            config.EnableSwagger(swagger =>
                    {
                        ...
                        //
                        //swagger.SingleApiVersion("v1", "malone.Core.Sample.AdoNet.Firebird.Api");
                        ...
                        //
                        swagger.IncludeXmlComments(System.IO.Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory, "bin", "malone.Core.Sample.AdoNet.Firebird.Api.xml"));
