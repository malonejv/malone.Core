...
using malone.Core.Sample.EF.Firebird.Middle.DAL.Context.Conventions;
...
namespace malone.Core.Sample.EF.Firebird.Middle.DAL.Context
{
    public class SampleContext : CoreIdentityDbContext //CoreDbContext
    {
            ...
            : base(connectionStringName)
        {
            ...
            //<entityFramework>
            //<contexts>
            //  <context type="malone.Core.Sample.EF.Firebird.Middle.DAL.Context.SampleContext, malone.Core.Sample.EF.Firebird.Middle" disableDatabaseInitialization="false">
            //    <databaseInitializer type="malone.Core.Sample.EF.Firebird.Middle.DAL.Context.SampleContextInitializer, malone.Core.Sample.EF.Firebird.Middle" />
            //  </context>
            //</contexts>
            //</entityFramework>
