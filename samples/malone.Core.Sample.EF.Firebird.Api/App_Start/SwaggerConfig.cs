            ...
            config.EnableSwagger(swagger =>
                    {
                        ...
                        //
                        //swagger.SingleApiVersion("v1", "malone.Core.Sample.EF.Firebird.Api");
                        ...
                        //
                        swagger.IncludeXmlComments(System.IO.Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory, "bin", "malone.Core.Sample.EF.Firebird.Api.xml"));
