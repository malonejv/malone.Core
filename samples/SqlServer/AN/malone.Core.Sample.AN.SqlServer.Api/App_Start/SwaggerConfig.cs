using malone.Core.Sample.AN.SqlServer.Api.App_Start;
            ...
            config.EnableSwagger(swagger =>
                    {
                        ...
                        //
                        //swagger.SingleApiVersion("v1", "malone.Core.Sample.AN.SqlServer.Api");
                        ...
                        //
                        swagger.IncludeXmlComments(System.IO.Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory, "bin", "malone.Core.Sample.AN.SqlServer.Api.xml"));
