...
using malone.Core.Sample.AdoNet.SqlServer.Api.App_Start;
            ...
            config.EnableSwagger(swagger =>
                    {
                        ...
                        //
                        //swagger.SingleApiVersion("v1", "malone.Core.Sample.AdoNet.SqlServer.Api");
                        ...
                        //
                        swagger.IncludeXmlComments(System.IO.Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory, "bin", "malone.Core.Sample.AdoNet.SqlServer.Api.xml"));
