...
{
	public class TodoListBV : ServiceValidator<TodoList>, ITodoListBV
    {
        ...
        public TodoListBV(IRepository<TodoList> repository, IErrorLocalizationHandler errorLocalizationHandler, ICoreLogger logger)
            : base()
        {
