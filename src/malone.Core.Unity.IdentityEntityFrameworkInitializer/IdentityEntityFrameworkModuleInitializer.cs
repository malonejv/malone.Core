...
namespace malone.Core.Unity.IdentityEntityFrameworkInitializer
{
	public class IdentityEntityFrameworkModuleInitializer : IModuleInitializer<IUnityContainer>
	{
